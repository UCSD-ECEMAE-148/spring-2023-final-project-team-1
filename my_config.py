SAVE_PATH_BTN = "r"             # joystick button to save path
RESET_ORIGIN_BTN = "l"       # joystick button to press to move car back to origin
ERASE_PATH_BTN = "y"
...
PATH_SEARCH_LENGTH = 20           # number of points to search for closest point, None to search entire path
PATH_LOOK_AHEAD = 2 # for 0.3 2                 # number of points ahead of the closest point to include in cte track
PATH_LOOK_BEHIND = 2                # number of points behind the closest point to include in cte track   
# PID_P = 0.11                    # proportional mult for PID path follower
# PID_I = 0.0006                    # integral mult for PID path follower
# PID_D = 0.16                # differential mult for PID path follower
...
PID_D_DELTA = 0.01
PID_P_DELTA = 0.01
INC_PID_D_BTN = "r bump"            # button to change PID 'D' constant by PID_D_DELTA
DEC_PID_D_BTN = "l bump"

#0.5 fr fr
# PATH_LOOK_AHEAD = 2 # for 0.3 2                 # number of points ahead of the closest point to include in cte track
# PATH_LOOK_BEHIND = 2                # number of points behind the closest point to include in cte track   
# PID_P = 0.155                     # proportional mult for PID path follower
# PID_I = 0.0007                    # integral mult for PID path follower
# PID_D = 0.145                # differential mult for PID path follower
# PID_THROTTLE = 0.55 


#0.5 inda pt 2
# PID_P = 0.155                     # proportional mult for PID path follower
# PID_I = 0.0004                    # integral mult for PID path follower
# PID_D = 0.137                # differential mult for PID path follower
# PID_THROTTLE = 0.55 
...
# PID_P = 0.09                     # proportional mult for PID path follower
# PID_I = 0.01                    # integral mult for PID path follower
# PID_D = 0.05                # differential mult for PID path follower
# PID_THROTTLE = 0.7                 # constant throttle value during path following
...
# PID_I = 0.0000                    # integral mult for PID path follower
# PID_D = 0.1                # differential mult for PID path follower
# PID_THROTTLE = 0.5   


#might work for fast
# PID_P = 0.280                     # proportional mult for PID path follower
# PID_I = 0.015                    # integral mult for PID path follower
# PID_D = 0.250  
# Starting HERE
PID_P = 0.25                       # proportional mult for PID path follower
...
#0.40 money
# PID_P = 0.17                       # proportional mult for PID path follower
# PID_I = 0.0000                      # integral mult for PID path follower
# PID_D = 0.2 
# PID_THROTTLE = 0.40 


# PID_P = 0.42                     # proportional mult for PID path follower
...
GPS_DEBUG = False  # set to True to log UTM position (beware; lots of logging!)
                # amount the inc/dec function will change the D value
#CAMERA
